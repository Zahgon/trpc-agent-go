...
func WithMaxIterations(max int) Option { _ = "STUB: not implemented"; return *new(Option) }
...
func WithEscalationFunc(f EscalationFunc) Option { _ = "STUB: not implemented"; return *new(Option) }
