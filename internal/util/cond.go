...
func If[T any](cond bool, onTrue, onFalse T) T { _ = "STUB: not implemented"; return *new(T) }

// IfLazy is a variant of [If], accepts [Lazy] values.
func IfLazy[T any](cond bool, onTrue, onFalse Lazy[T]) T { _ = "STUB: not implemented"; return *new(T) }
