...
func NewClientV7(esClient *esv7.Client) Client { _ = "STUB: not implemented"; return *new(Client) }
...
func (c *clientV7) Ping(ctx context.Context) error { _ = "STUB: not implemented"; return nil }
