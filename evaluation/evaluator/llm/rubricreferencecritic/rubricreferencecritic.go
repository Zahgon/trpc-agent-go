...
func (e *rubricReferenceCriticEvaluator) Name() string { _ = "STUB: not implemented"; return "" }

// Description returns the description of the evaluator.
func (e *rubricReferenceCriticEvaluator) Description() string { _ = "STUB: not implemented"; return "" }
