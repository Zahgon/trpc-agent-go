...
func NewClientV8(esClient *esv8.Client) Client { _ = "STUB: not implemented"; return *new(Client) }
...
func (c *clientV8) Ping(ctx context.Context) error { _ = "STUB: not implemented"; return nil }
